  ...
  return (
    <div className="md:px-10 px-7 my-10" id="contact">
      ...
      <div className="flex ">
        ...
        <a className="ml-4" href="https://github.com/Zarmo17" target="_blank" rel="noreferrer">
        <img src={instagram} alt="" />
        </a>
        <a className="ml-4" href="mailto:anpch@example.com" target="_blank" rel="noreferrer">
        <img src={dribbble} alt="" />
        </a>
        <a className="ml-4" href="mailto:gervaisyameogo17@gmail.com" target="_blank" rel="noreferrer">
        <img src={email} alt="" />
        </a>
      </div>
        </div>
